...
assertIncludes(homepage, '把同一段邀请发给你的 Agent', 'Homepage agent strip should use scenario-driven Chinese copy');
assertIncludes(homepage, 'Claude Code、Codex、Cursor、ChatGPT 或任意 HTTP Agent，都可以读取文档并写入新内容。', 'Homepage agent strip should explain compatible agents');
