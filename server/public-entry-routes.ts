...
1. **AI 新增内容会直接进文档**
   ...
   让 Agent 补一段、加一节、整理素材，它会把新内容直接写进正文，并显示为紫色。

2. **AI 修改你写过的内容时，需要你确认**

   如果 Agent 想改明确属于人类作者的文字，Zoon 会先把旧内容划线，再把 AI 的紫色替换内容放在后面。你点击紫色替换内容，可以选择「确认替换」或「保留原文」。

所以你不用担心 AI 静默覆盖你的原文：新增可以快，改人类内容必须可控。
...
3. **你审校** — 普通紫色内容可以点一下改、删或复制重写任务；如果是 AI 替换你原文，会出现确认替换弹窗。
...
- 写一句自己的原文，再让 AI 改写它——你会看到旧文划线、新文紫色，最后由你确认
